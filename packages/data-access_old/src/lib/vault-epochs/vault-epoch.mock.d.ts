...
import { VaultEpoch, VaultEpochAPRs, VaultEpochQueue, VaultEpochInstantWithdraws, VaultEpochWithdraws, VaultCdoEpochData, VaultEpochAPYs, VaultCreditExtended } from './vault-epoch.model';
/**
 * Vault Epoch Mock
 */
