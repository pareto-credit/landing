 ...
 * @returns the rule vault points
 */
export declare function getCampaignBoostVaultPoints(campaign: Campaign, boost: CampaignBoost, transactions: Transaction[], walletBlocks: WalletBlock[], token: Token): CampaignMetrics;
/**
 ...
 * @returns boost rewards
 */
export declare function calculateBoostBlockRewards(token: Token, reward: CampaignReward, walletBlock: WalletBlock, balanceField?: WalletBlockBalanceField, protocols?: Web3Protocol[]): {
    points?: BigNumber;
