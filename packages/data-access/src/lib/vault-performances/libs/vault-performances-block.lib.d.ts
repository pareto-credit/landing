 ...
 */
export declare function getVaultRealizedAPY(age: number, earningsPercentage: number): number;
/**
 ...
 */
export declare function getVaultPerformance({ current, last }: VaultBlocks, token: Token, tokenPrice: TokenPriceData, walletBlocksHolders: WalletBlock[], lastPerformance?: VaultPerformance, redeemTransactions?: Transaction[], epochsDuration?: number): VaultBlockPerformance;
/**
