...
import { VaultEpoch, VaultEpochAPRs, VaultEpochQueue, VaultEpochInstantWithdraws, VaultEpochWithdraws, VaultCdoEpochData, VaultEpochAPYs } from './vault-epoch.model';
/**
 * Vault Epoch Mock
 */
