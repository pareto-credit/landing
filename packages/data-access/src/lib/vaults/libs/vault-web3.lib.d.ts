...
import { Web3CallData, Web3Clients, Web3ContractMethod, Web3DataParam, Web3Entity, Web3Event } from '../../web3-client';
 ...
 */
export declare function getVaultPoolEventType(vault: Vault, from: string, to: string): TransactionType | undefined;
/**
 ...
 * @returns true | false
 */
export declare function checkVaultPoolInternalTransfer(vault: Vault, from: string, to: string): boolean;
/**
