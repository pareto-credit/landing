 ...
 */
export declare function getWalletPerformance(feePercentage: number, token: Token, lastWalletBlock: WalletBlockData, lastWalletPerformance: WalletPerformance | undefined, { current: currentVault, last: lastVault }: VaultBlocks, currentVaultPerformance: VaultBlockPerformance, tokenPrice: TokenPriceData, distributedRewards?: WalletDistributedRewards[]): WalletBlockPerformance;
/**
