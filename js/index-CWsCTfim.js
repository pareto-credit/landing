...
import 'kleur/colors';
import { C as CommonComponents, $ as $$Section, H as HomePage, a as $$Page, d as defaultLang } from './section-Wj4VTB2y.js';
/* empty css                        */
import 'clsx';

const $$Astro$h = createAstro("https://real-not-now.web.app/");
const $$TabItem = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$h, $$props, $$slots);
  Astro2.self = $$TabItem;
  const props = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="tabs-list__item"${addAttribute(props.address, "data-address")}${addAttribute(props.index, "data-nav-id")}> <div class="tabs-list__item-header"> <div class="icon"> <img src="#"${addAttribute(props.icon, "data-src")} class="lazy" data-load-priority="1" alt="icon"> </div> <div class="title-wrap"> <div class="title-wrap__title"> <h4 class="title-h4 deep-forest"> ${props.title} </h4> </div> <div class="title-wrap__description"> <p class="desc-4 muted-green"> ${props.description} </p> </div> </div> <div class="bg"> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(props.bgImage)}` })} </div> </div> <div class="tabs-list__item-body"> <div> <div class="badge-list"> ${props.badges.map((badge) => renderTemplate`<div class="badge"> <span class="desc-5 deep-forest">${badge}</span> </div>`)} </div> <div class="item-description"> <p class="desc-4 muted-green"> ${props.itemDescription} </p> </div> </div> <div class="info-block"> ${props.infoBlock.map((item) => renderTemplate`<div class="info-block__item"${addAttribute(item.id, "data-id")}> <div class="title desc-4 muted-green"> <span class="desc-4 muted-green">${item.title}</span> </div> <div class="value "> <h4 class="title-h4 deep-forest">${item.value}</h4> </div> </div>`)} </div> </div> </div>`;
}, "/Users/samuelecester/Desktop/git/pareto-landing/src/components/common/tabs/tabItem.astro", void 0);

const $$Astro$g = createAstro("https://real-not-now.web.app/");
...
const $$View$5 = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div id="ticker-container"${addAttribute(`${className} my-reel`, "class")}> ${renderTemplate`<ul${addAttribute("ticker text-js  my-reel-wrap", "class")}> ${tickerLiElement.map((imgSrc) => {
    return renderTemplate`<li class="ticker__li my-reel-item"> <img${addAttribute(imgSrc, "src")} alt="logo"> </li>`;
  })} </ul>`} </div> `;
}, "/Users/samuelecester/Desktop/git/pareto-landing/src/components/common/runningLine/view.astro", void 0);

const falcon = "/assets/FalconX-CyUi2jB5.svg";

const rockaway = "/assets/RockawayX-hnyKOCKD.svg";

const digital = "/assets/Fasanara_Digital-B9dJHMY5.svg";

const bastion = "/assets/Bastion_Trading-CbXYrsIU.svg";

const m11 = "/assets/m11-Dz8nVwh0.svg";
...
const $$CommunityItem = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$4, $$props, $$slots);
  Astro2.self = $$CommunityItem;
  const { COPY, id } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="community-section__list__item"> <a${addAttribute(COPY.btn.link, "href")} class="community-section__list__item__link" target="_blank"> <div class="community-section__list__item__wrap"> <div class="community-section__list__item__img"> <img src="#"${addAttribute(COPY.img, "data-src")} alt="icon" data-load-priority="4" class="lazy"> </div> <div class="community-section__list__item__text"> <h4 class="title-h3 dark-green">${COPY.title}</h4> <p class="desc-2 sage">${COPY.description}</p> </div> </div> <span class="btn btn-secondary"> <span class="nav up-text">${COPY.btn.text}</span> </span> </a> </div>`;
}, "/Users/samuelecester/Desktop/git/pareto-landing/src/components/sections/home/community/communityItem.astro", void 0);
...
const $$View$1 = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$View$1;
  const { COPY, id } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "className": "community-section", "id": id }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container"> <div class="title-wrap"> <span class="desc-4 teal up-text">${COPY.subTitle}</span> <h2 class="title-h2 dark-green">${COPY.title}</h2> <p class="desc-2 muted-green">${COPY.description}</p> </div> <div class="community-section__list"> ${COPY.list.map((item, id2) => renderTemplate`${renderComponent($$result2, "CommunityItem", $$CommunityItem, { "id": `list-item-${id2}`, "COPY": item })}`)} </div> </div> ` })} `;
}, "/Users/samuelecester/Desktop/git/pareto-landing/src/components/sections/home/community/view.astro", void 0);
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PageLayot", $$Page, { ...HomePage, "locale": locale }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HeroSection", $$View$b, { "COPY": COPY.heroSection, "id": HomePageSections.Hero })} ${renderComponent($$result2, "Ecosystem", $$View$4, { "COPY": COPY.Ecosystem, "id": HomePageSections.Ecosystem })} ${renderComponent($$result2, "SolutionSection", $$View$a, { "COPY": COPY.solutionSection, "id": HomePageSections.Solution })} ${renderComponent($$result2, "HowItWorks", $$View$9, { "COPY": COPY.HowItWorks, "id": HomePageSections.HowItWorks })} ${renderComponent($$result2, "OurAdvantage", $$View$7, { "COPY": COPY.OurAdvantage, "id": HomePageSections.OurAdvantage })} ${renderComponent($$result2, "Transparent", $$View$6, { "COPY": COPY.Transparent, "id": HomePageSections.Transparent })} ${renderComponent($$result2, "GetInTouch", $$View$2, { "COPY": COPY.GetInTouch, "id": HomePageSections.GetInTouch })} ${renderComponent($$result2, "NewsSection", $$View, { "COPY": COPY.NewsSection, "id": HomePageSections.News })} ${renderComponent($$result2, "CommunitySection", $$View$1, { "COPY": COPY.CommunitySection, "id": HomePageSections.Community })} ` })}`;
