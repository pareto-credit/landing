          ...
          {ecosystemSegments.map((segment, idx) => (
            ...
            >
              <div className="relative h-[13rem] w-full overflow-hidden bg-[var(--color-bg-dark)] xl:h-[14rem]">
                ...
                <div className="absolute bottom-5 left-5 right-5 z-20 md:bottom-6 md:left-6 md:right-6 xl:bottom-7 xl:left-7 xl:right-7">
                  ...
                  <div className="mt-3 flex min-h-[3.4rem] items-end xl:mt-4 xl:min-h-[3.75rem]">
                    <h3
                      className="text-balance text-[1.5rem] font-bold leading-[1.05] tracking-tight text-[var(--color-text-inverse)] drop-shadow-[0_4px_18px_rgba(0,0,0,0.35)] md:text-[1.62rem] xl:text-[1.74rem]"
              ...
              <div className="flex flex-1 flex-col bg-[var(--color-bg-light-alt)] p-6 xl:p-7">
                <p className="mb-6 min-h-[60px] text-sm leading-relaxed text-[color:rgb(41_59_51_/_0.90)] xl:mb-7">
                  {segment.desc}
                </p>
